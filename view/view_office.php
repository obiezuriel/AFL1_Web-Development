...
<body class="bg-zinc-300">
    <div class="container mx-auto p-6">
            ...
            <table class="min-w-full bg-white border border-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-b">Kota</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            ...
                            <a href="../controller/controller_office.php?deleteID=<?=$index?>" class="text-red-600 hover:text-red-900" onclick="return confirm('Do you want to delete this office?');">Delete</a>
                        </td>
                    </tr>
                    <?php
                    }
        ...
        <div class="flex justify-center mt-6">
            <a href="view_addoffice.php" class="bg-zinc-800 hover:bg-zinc-500 text-white font-semibold py-3 px-6 rounded-lg transition duration-200">
                Add Office
            </a>
        </div>
